...
export default async function CalendarPage({
  ...
  return (
    <>
      ...
      <p className="muted">Docket Watch</p>
      ...
      <p>
        <a href={`/cal?year=${prev.year}&month=${prev.month}`}>Previous</a>
        {" · "}
        <a href={`/cal?year=${now.getFullYear()}&month=${now.getMonth()}`}>This month</a>
        {" · "}
        <a href={`/cal?year=${next.year}&month=${next.month}`}>Next</a>
        {" · "}
        <a href="/timl">Timeline</a>
      </p>
