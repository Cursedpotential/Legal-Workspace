...
export const SURFACES: Surface[] = [
  ...
  { path: "/agreements", label: "Document review", group: "Drafting", help: "Review and compare court orders, offers, proposals, and drafts.", icon: "file" },
  ...
  { path: "/evidence-requests", label: "Discovery requests", group: "Operations", help: "Written questions and document requests.", icon: "folder" },
...
export function enrichSurface(row: Surface): Surface {
  ...
  return {
    ...
    help: row.path === "/agreements" ? local?.help : row.help || local?.help || row.label,
